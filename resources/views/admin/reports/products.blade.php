...
<tr><td>{{ $i+1 }}</td><td><strong>{{ $p->name }}</strong></td><td class="text-muted">{{ $p->sku }}</td><td>{{ $p->units_sold }}</td><td class="font-weight-bold">${{ number_format($p->total_revenue, 2) }}</td></tr>
