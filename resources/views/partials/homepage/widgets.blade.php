...
<div class="{{ $s['container_class'] ?? 'container' }}">
    <div class="product-widgets row pt-1">
        ...
        <div class="{{ $s['col_class'] ?? 'col-md-4 col-sm-6' }} pb-5 appear-animate" data-animation-name="fadeInRightShorter">
        ...
        <div class="{{ $s['col_class'] ?? 'col-md-4 col-sm-6' }} pb-5 appear-animate" data-animation-delay="100" data-animation-duration="1500">
        ...
        <div class="{{ $s['col_class'] ?? 'col-md-4 col-sm-6' }} pb-5 appear-animate" data-animation-name="fadeInLeftShorter">
